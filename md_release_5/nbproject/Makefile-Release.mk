...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/md_release_5: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/md_release_5 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/BinFileReader.o: BinFileReader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinFileReader.o BinFileReader.cpp

${OBJECTDIR}/CombinedSummary.o: CombinedSummary.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CombinedSummary.o CombinedSummary.cpp

${OBJECTDIR}/DM7520/lib/librtd-dm75xx.o: DM7520/lib/librtd-dm75xx.cpp
	${MKDIR} -p ${OBJECTDIR}/DM7520/lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DM7520/lib/librtd-dm75xx.o DM7520/lib/librtd-dm75xx.cpp

${OBJECTDIR}/DMAReader.o: DMAReader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DMAReader.o DMAReader.cpp

${OBJECTDIR}/DM_7520.o: DM_7520.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DM_7520.o DM_7520.cpp
...
${OBJECTDIR}/IReader.o: IReader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IReader.o IReader.cpp

${OBJECTDIR}/ISummary.o: ISummary.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ISummary.o ISummary.cpp

${OBJECTDIR}/Loggers.o: Loggers.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Loggers.o Loggers.cpp

${OBJECTDIR}/Parsers.o: Parsers.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Parsers.o Parsers.cpp

${OBJECTDIR}/Recepts.o: Recepts.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Recepts.o Recepts.cpp

${OBJECTDIR}/SummFileReader.o: SummFileReader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SummFileReader.o SummFileReader.cpp

${OBJECTDIR}/Summary.o: Summary.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Summary.o Summary.cpp

${OBJECTDIR}/UdpReader.o: UdpReader.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UdpReader.o UdpReader.cpp
